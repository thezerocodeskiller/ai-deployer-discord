...
Take the first few words from the tweet text to meet your 6-suggestion quota.
...
Now, await the user's data and execute your directives. Your entire response must be ONLY a valid JSON array.`;
        ...
        **YOUR TASK:**
        Execute your directives. Prioritize creative fusion but guarantee 6 concrete, literal results that adhere strictly to the character limits. Your first 2 suggestions are your strongest.
